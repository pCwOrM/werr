...
\textbf{Campaign 3: Adversarial Filter Hardening} & Deceptive prompt-injection \& decoy trigger words & 100 Questions (5 Stress Categories) & Chordial Resonance ($\mathcal{T}_{\text{desc}} = 0.045$) & \textbf{0.0\% Trap Exploit Rate} (0/10 false trigger activations) \\
...
\subsection{Campaign 3: Adversarial Filter Hardening}
...
\end{enumerate}
Under the Hardened Chord Filter with $\mathcal{T}_{\text{desc}} = 0.045$, the engine selected the deceptive trap option **0 times out of 10** (**0.0\% exploit vulnerability**), confirming that 95.5\% descriptive attenuation successfully insulates decisions from prompt-injection.
