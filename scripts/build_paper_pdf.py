...
<div class="full-width-section">
  <table class="academic-table">
    <caption><strong>Table I.</strong> Architectural & System Paradigm Comparison: Centralized Cloud LLM (TypeSafe AI / Jev), Local Open-Weight LLM (OpenJev 4B), and werr (Universal Fractal Map v2.0)</caption>
    <thead>
      <tr>
        <th>Dimension / Metric</th>
        <th>TypeSafe AI (Jev)</th>
        <th>Local Compact LLM (OpenJev 4B)</th>
        <th>werr (Universal Fractal Map v2.0)</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td><strong>Mandelbrot Boundary Dynamics (\(\partial \mathcal{M}\)) + Tripod Fusion</strong></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><strong>3.31 ms (Telemetry) / 8.8 ms (231-Item CPU Benchmark)</strong></td>
      </tr>
      <tr>
        <td><strong>Hardware Requirement</strong></td>
        <td>High-Speed Internet Connection</td>
        <td>High-End CUDA GPU</td>
        <td><strong>Any Standard Commodity CPU / Microcontroller (0 GPU)</strong></td>
      </tr>
      <tr>
...
<div class="two-column-body">
  ...
  <h3>E. Multi-Scale Harmonic Tripod Fusion</h3>
  <p>
    A critical limitation of single-zoom fractal evaluation (\(z = 50.0\)) is scale-invariance collapse: complex decision tasks simultaneously require macro-scale boundary separation and fine-grained micro-boundary resolution. In Version 2.0, we introduce the <strong>Multi-Scale Harmonic Tripod</strong>. Rather than evaluating a single escape plane, the engine constructs a geometric triad across three harmonic zoom scales:
  </p>
  <div class="equation">
  ...
  <h3>C. Domainless Monolithic vs. Multi-Domain Routing Ablation</h3>
  <p>
    A foundational question in procedural fractal intelligence is whether partitioned multi-domain router gates are strictly necessary, or whether a monolithic universal fractal escape space generalizes more effectively. To resolve this, we benchmarked the pure monolithic kernel against the multi-domain routing network across all 231 decisions of the JevBench public suite (Table IV).
  </p>
  <table class="academic-table">
    <caption><strong>Table IV.</strong> Domainless Monolithic vs. Multi-Domain Routing Ablation Benchmark</caption>
    <thead>
      <tr>
        <th>Configuration</th>
        <th>Easy Split (75)</th>
        <th>Original Split (72)</th>
        <th>Hard Split (84)</th>
    ...
    <tbody>
      <tr>
        <td>Partitioned Domain Gates</td>
        <td>64.0%</td>
        <td>52.8%</td>
        <td>40.5%</td>
        <td>51.5%</td>
      ...
      <tr class="total-border">
        <td><strong>Universal Monolithic Kernel (werr)</strong></td>
  ...
  <p>
    <strong>Decentralized On-Chain AI Oracles:</strong> Decentralized applications in DeFi and governance cannot run deep neural models inside the Ethereum Virtual Machine (EVM) due to gas limits. Existing AI oracles rely on centralized off-chain servers with cryptographic signatures [6], while ZK-ML [5] incurs 10&ndash;300s proving latencies and 250,000&ndash;500,000 gas, preventing intra-block protection against flash-loan attacks. <em>werr</em> overcomes this limitation through the open-source on-chain reference implementation <strong>werracle</strong> (<a href="https://github.com/pCwOrM/werracle">https://github.com/pCwOrM/werracle</a>): (1) the complete 24-byte coordinate seed $(c_x, c_y, \text{zoom})$ is encoded as Q16.16 fixed-point integers and bit-packed into a single 32-byte EVM storage slot (<code>bytes32</code>, 100 gas warm SLOAD); (2) native on-chain execution evaluates a 16-point ($4 \times 4$) Pareto micro-grid ($M_{\max} = 12$) via integer bit-shifts in standard EVM bytecode; (3) benchmarked live on bare-metal testnet infrastructure (<code>mechsrv</code>, Anvil EVM, Chain ID 4242, &gt;100,000 blocks evaluated), atomic execution consumes only <strong>21,438 gas</strong> (<code>noul</code>) and <strong>23,150 gas</strong> (Uniswap v4 dynamic fee hook), executing in &lt;1 ms inside the same block (&lt; $0.001 on L2s like Arbitrum and Base); and (4) deep multi-scale tripod evaluations can be attested on-chain via compact Merkle boundary proofs under 50,000 gas. A live interactive web simulator is accessible at <a href="https://pcworm.github.io/werracle/">https://pcworm.github.io/werracle/</a>.
  </p>
  ...
  <p class="no-indent">
    ...
    &bull; <strong>On-Chain EVM Oracle Repository & Simulator:</strong> <a href="https://github.com/pCwOrM/werracle">https://github.com/pCwOrM/werracle</a> (Live Simulator: <a href="https://pcworm.github.io/werracle/">https://pcworm.github.io/werracle/</a>; Live Devnet: <a href="https://api.answerr.me:4431/werracle/status">https://api.answerr.me:4431/werracle/status</a>)<br>
    ...
    &bull; <strong>JevBench In-Tree Adapter & Spec:</strong> <a href="https://github.com/pCwOrM/werr/tree/main/benchmarks/jevbench">https://github.com/pCwOrM/werr/tree/main/benchmarks/jevbench</a>
  </p>
